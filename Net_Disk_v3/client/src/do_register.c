...
void do_register(int route_sfd)
{
    ...
    train_t register_name_info = {0};
    register_name_info.data_len = user_name_len;
    strcpy(register_name_info.data_buf, user_name);
    send_cmd(&register_name_info, CMD_REGISTER, route_sfd);
